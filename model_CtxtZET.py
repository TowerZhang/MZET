...
class CtxtModel(BaseModel):
    def __init__(self, config):
        super(CtxtModel, self).__init__(config)
    ...
    def run_epoch(self, epoch):
        ...
        nbatches = (self.config.train_mention_length + batch_size - 1)
    ...
    def evaluate_level1(self):
        level1 = [self.config.mention_level1, self.config.embedding_level1, self.left_context_level1,
                  self.right_context_level1, self.config.label_level1, self.config.length_level1]
    ...
    def evaluate_level2(self):
        level2 = [self.config.mention_level2, self.config.embedding_level2,self.left_context_level2,
                  self.right_context_level2, self.config.label_level2, self.config.length_level2]
